...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    app.post('/userprofil', (req, res) => {
        let data = { Name: req.body.Name, Website: req.body.Website, Bio: req.body.Bio, PhoneNumber: req.body.PhoneNumber, idUser: req.body.idUser  }
    ...
    app.post('/postfollowing/cek', (req, res) => {
        ...
        let sql = `SELECT * FROM following2 where idUser =${req.body.idUser}  and idUserFollowing = ${req.body.idUserOrang2}`;
    ...
    app.post('/postfollowing', (req, res) => {
        ...
        let sql = 'insert into following2 set ?';
        db.query(sql, data, (err, result) => {
            if (err) throw err;
            console.log(result);
            res.send(result);
...
/////////////////////////////////////////////////// GET ////////////////////////////////////////////////////////
    ...
    app.get('/homePhoto2/:idUser', (req, res) => {
        ...
        let sql =`select * from user u join following2 f on u.idUser = f.idUser join photo p on f.idUserFollowing = p.idUser join userprofile s on p.idUser = s.idUser where u.idUser = ${req.params.idUser} order by waktu desc`;
        db.query(sql, (err, result) => {
            if (err) throw err;
            console.log(result);
            res.send(result);
    ...
    app.get('/photouser/:idUser', (req, res) => {
        let sql = `select * from photo where photo.idUser = ${req.params.idUser} ORDER BY waktu DESC`;
        db.query(sql, (err, result) => {
            if (err) throw err;
            console.log(result);
            res.send(result);
    ...
    app.get('/userProfilPostPhoto/:Username', (req, res) => { 
        ...
        let sql = `select user.Username, user.idUser, photo.PhotoName, photo.waktu, photo.idPhoto, userprofile.bio, userprofile.Website, userprofile.Photop, userprofile.Name from user join photo on user.idUser = photo.idUser join userprofile on user.idUser = userprofile.idUser where user.Username = "${req.params.Username}"  ORDER BY waktu DESC`;
        db.query(sql, (err, result) => {
            if (err) throw err;
            console.log(result);
            res.send(result);
    ...
    app.get('/userprofilorang/:idUser', (req, res) => {
        let sql = `select user.idUser, user.Username, userprofile.Name, userprofile.Website, userprofile.Bio, userprofile.PhoneNumber, userprofile.Photop from user join userprofile on user.idUser = userprofile.idUser where userprofile.idUser =${req.params.idUser};`;
        db.query(sql, (err, result) => {
            if (err) throw err;
            console.log(result);
            res.send(result);
...
//////////////////////////////////////Profil User///////////////////////////////////////////////
    ...
    app.get('/getallfollowing/followers/:idUser', (req, res) => {
        let sql = `select * from following2 where idUserFollowing=${req.params.idUser}`
        db.query(sql, (err, result) => {
            if (err) throw err;
            console.log(result);
            res.send(result);
    ...
    app.get('/getfollowing/:idUser/:idUserFollowing', (req, res) => {
        let sql = `select * from following2 where idUser=${req.params.idUser} and idUserFollowing=${req.params.idUserFollowing}`
        db.query(sql, (err, result) => {
            if (err) throw err;
            console.log(result);
            res.send(result);
    ...
    app.get('/getallfollowing/followers2/:idUserOrang2', (req, res) => {
        let sql = `select * from following2 where idUserFollowing=${req.params.idUserOrang2}`
        db.query(sql, (err, result) => {
            if (err) throw err;
            console.log(result);
            res.send(result);
...
app.get('/getallfollowernavbar/:idUser', (req, res) => {
    let sql =`select userprofile.Photop, following2.idUser, following2.idUserFollowing, user.Username from userprofile join following2 on userprofile.idUser = following2.idUser join user on following2.idUser = user.idUser where idUserFollowing =${req.params.idUser}`;
    db.query(sql, (err, result) => {
        if (err) throw err;
        console.log(result);
        res.send(result);
...
/////////////////////////////////////////////////// PUT ////////////////////////////////////////////////////////
    ...
    app.put('/userprofileupdate/:idUser', (req, res) => {
        let data = { Name: req.body.Name, Website: req.body.Website, Bio: req.body.Bio, PhoneNumber: req.body.PhoneNumber }
...
/////////////////////////////////////////////////// DELETE ////////////////////////////////////////////////////////
    ...
    app.delete('/unfollow/:idUser/:idUserFollowing2', (req, res) => {
        let sql = `DELETE from following2 WHERE idUser='${req.params.idUser}' and idUserFollowing = '${req.params.idUserFollowing2}'`;
        db.query(sql, (err, res1) => {
            if (err) throw err;
            console.log(res);
            res.send(res1);
